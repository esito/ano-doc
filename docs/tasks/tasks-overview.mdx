...
Task Groups are collection of Work Tasks. Work Tasks are collection of anonymization rules.
...
- Naming two Task Groups the same renders them indistinguishable when runningz
