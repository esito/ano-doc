...
In `update` Work Tasks, you can use any of the [`mask`](../rules/mask/overview-mask), [`randomize`](../rules/randomize/overview-randomize) or the [`shuffle`](../rules/shuffle-rule) rule strategies.

[Visit the rules section](../rules/overview-rules) for more information on how to write `update` task rules.
