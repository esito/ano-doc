...
For simple conversions, use the in-built convertion functions described below. For business specific logic, you will need to write your own conversion function.
