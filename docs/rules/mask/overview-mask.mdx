...
- [`convert`](../convert.mdx) refers to a java convertion function in the DBmasker project that will take the input source values as inputs before passing it to the rule
