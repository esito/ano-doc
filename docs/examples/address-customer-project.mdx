...
Now that we have written the Tasks and Rules Section in the `address_customer.ano` file, we follow the steps in [From ANO to Task Execution](../from-ano-to-execution/overview-from-ano-to-execution) to get the java project.
