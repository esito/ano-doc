...
DBmasker provides you with the ANO developing language to anonymize databases.

- No proprietary software installation
- No Database Service Provider lock-in
- No fuzz

Simply write your desired anonymization logic as code. Then generate a Java application using [our services](../services/overview). Then run this application whenever you need to populate or anonymize your database tables.
...
- [Introducing the ANO Domain Specific Language](../sql-to-ano/overview)

- [ANO Tasks](../tasks/overview)

- [ANO Rules](../rules/overview)

- [Custom User Classes and Community Collaboration](../custom/overview)

---

## Challenges introduced by GDPR

The main challenge DBmasker addresses is:
...
DBmasker utilizes the ANO domain specific language (DSL) for writing tasks and rules for anonymization. ANO lets you write advanced rules with propagating logic to handle constraints and edge cases in your database design. Your tasks and rules will be written in an `.ano` file.
