...
The ANO language is a Domain Specific Language based upon ANTLR4.
...
- Our [**DBano service**](../services/dbano) will write the first two sections of the file for you
...
The ANO language is written in `.ano` files. The `.ano` UpdateNamesUsingFiles consists of four distinct sections.
